...
m.strength.csi  <- map2stan(
  alist(
    
    CSI ~ dzagamma2( p, mu , scale ),
  ...
  data=data.strength.csi, cores=3 , chains=3 , warmup=1000, iter=4000, constraints=list(scale="lower=0") , control=list(adapt_delta=0.99), WAIC=TRUE
...
#
#Model with composite sociality index
#

m.eq.index.csi <- map2stan(
  alist(
    ...
    c(ap_dyad, bp_rankDiff_dyad )[dyad] ~ dmvnormNC( sigma_dyad, Rho_dyad ),
    c(ap) ~ dnorm(0,2), 
    c(bp_rank, bp_age, bp_rankDiff, bp_ageDiff, bp_kin, bp_strength, bp_male_comm_size) ~ dnorm(0,2), 
    c(sigma_id, sigma_dyad) ~ dexp(1),
    c(Rho_id, Rho_dyad) ~ dlkjcorr(3),
    z[year] ~ dnorm(0,1),
    tau ~ dcauchy(0,1),
...
m.prior1.csi <- map2stan(
  ...
  data=data.prior1.csi, cores=3 , chains=3 , warmup=1000, iter=4000, constraints=list(scale="lower=0") , control=list(adapt_delta=0.99), WAIC=TRUE
  
)


m.prior2.csi <- map2stan(
  alist(
  ...
  data=data.prior2.csi, cores=3 , chains=3 , warmup=1000, iter=4000, constraints=list(scale="lower=0") , control=list(adapt_delta=0.99), WAIC=TRUE
  
)


m.prior3.csi <- map2stan(
  alist(
  ...
  data=data.prior3.csi, cores=3 , chains=3 , warmup=1000, iter=4000, constraints=list(scale="lower=0") , control=list(adapt_delta=0.99), WAIC=TRUE
  
)


m.prior4.csi <- map2stan(
  alist(
  ...
  data=data.prior4.csi, cores=3 , chains=3 , warmup=1000, iter=4000, constraints=list(scale="lower=0") , control=list(adapt_delta=0.99), WAIC=TRUE
  
)


m.prior5.csi <- map2stan(
  alist(
  ...
  data=data.prior5.csi, cores=3 , chains=3 , warmup=1000, iter=4000, constraints=list(scale="lower=0") , control=list(adapt_delta=0.99), WAIC=TRUE
